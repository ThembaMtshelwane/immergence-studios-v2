...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="drop-shadow-glow  h-screen grid grid-rows-4 p-4 md:grid-cols-2 lg:grid-cols-3 relative"
    >
      {toggle && (
      ...
      <div className="col-span-full md:col-span-1 lg:row-[3/4]  self-center justify-self-center sm:text-xl flex flex-col gap-2">
        <p>📍 Address:</p>
      ...
      <div className="col-span-full md:col-[2/3] lg:col-[3/4] lg:row-[3/4]  self-center justify-self-center sm:text-xl flex flex-col gap-2">
